...
def distort_image_with_randaugment(image, num_layers, magnitude, randomize=True,randaugment_transforms_set='review'):
  ...
  if randaugment_transforms_set=='review':
      available_ops = ['Scaling','TranslateX', 'TranslateY','ShearX', 'ShearY','Brightness', 'Sharpness','Color', 'Contrast', 'Equalize','Identity','HsvH','HsvS','HsvV','HedH','HedE','HedD', 'Elastic','GaussBlur','GaussNoise']  
  elif randaugment_transforms_set=='midl':
      available_ops = ['Scaling','TranslateX', 'TranslateY','ShearX', 'ShearY','Brightness', 'Sharpness','Color', 'Contrast', 'Equalize','Identity','Hsv','Hed', 'Elastic','GaussBlur','GaussNoise']  
